  ...
  return (
    <div className="min-h-screen bg-white text-stone-800 font-sans">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        {/* Hero Section */}
        <motion.section
          className="pt-12 pb-16 md:pt-20 md:pb-24 border-b border-stone-200"
          initial="initial"
          animate="animate"
          variants={fadeIn}
        >
          <div className="max-w-3xl">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight tracking-tight text-stone-800 mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            >
              <div className="lg:sticky lg:top-28">
                <nav className="flex flex-row lg:flex-col gap-4 lg:gap-3 flex-wrap">
                  <a href="#origin" className="text-sm font-medium text-stone-800 hover:text-indigo-600 transition-colors">
                    The Origin
                  </a>
                  <a href="#now" className="text-sm font-medium text-stone-500 hover:text-indigo-600 transition-colors">
                    Why AI
                  </a>
                  <a href="#work" className="text-sm font-medium text-stone-500 hover:text-indigo-600 transition-colors">
                    Recent Work
                  </a>
                  <a href="#vision" className="text-sm font-medium text-stone-500 hover:text-indigo-600 transition-colors">
                    What I'm After
                  </a>
                </nav>
              </div>
            ...
            >
              ...
              <section id="origin" className="mb-12 md:mb-16">
                <p className="text-base sm:text-lg leading-relaxed text-stone-600 mb-5">
              ...
              {/* Pull Quote */}
              <div className="my-12 md:my-16 py-8 border-t border-b border-stone-200">
                <blockquote className="text-xl sm:text-2xl md:text-3xl font-medium leading-snug text-stone-800">
              ...
              <section id="now" className="mb-12 md:mb-16">
                <h2 className="text-xs font-semibold tracking-widest uppercase text-stone-500 mb-5">
                  Why AI
                </h2>
                <p className="text-base sm:text-lg leading-relaxed text-stone-600 mb-5">
              ...
              {/* Highlight Card */}
              <div className="my-12 md:my-16 p-6 md:p-8 bg-stone-50 rounded-2xl border border-stone-200">
                <h3 className="text-lg sm:text-xl font-semibold text-stone-800 mb-3">
              ...
              <section className="pt-8 border-t border-stone-200">
                ...
                <p className="text-base leading-relaxed text-stone-500 mb-6">
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    ...
                    className="px-5 sm:px-6 py-2.5 sm:py-3 bg-stone-800 text-white rounded-full text-sm sm:text-base font-medium hover:bg-black transition-colors duration-300 flex items-center gap-2"
                    target="_blank"
                  ...
                  <a
                    ...
                    className="px-5 sm:px-6 py-2.5 sm:py-3 bg-white text-stone-800 rounded-full text-sm sm:text-base font-medium border border-stone-300 hover:border-stone-800 transition-colors duration-300"
                  >
                    Email me
                  </a>
                </div>
      ...
      {/* Footer */}
      <footer className="border-t border-stone-200 py-10 mt-8">
